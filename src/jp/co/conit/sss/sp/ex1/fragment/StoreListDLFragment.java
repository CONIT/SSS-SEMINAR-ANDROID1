...
public class StoreListDLFragment extends AbstStoreListFragment {
     ...
     * @author
     */
    class StoreBookDLAdapter extends ArrayAdapter<Book> {

        private LayoutInflater mInflater;

        public StoreBookDLAdapter(Context context, int textViewResourceId, List<Book> objects) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (v == null) {
                v = mInflater.inflate(R.layout.list_item_store_dl, parent, false);
                ...
                TextView dlCount = (TextView) v.findViewById(R.id.text_date_dl_count);
                viewHolder = new ViewHolder();
                viewHolder.titleText = title;
                viewHolder.authorText = author;
                viewHolder.priceText = price;
                viewHolder.dlCountText = dlCount;
                v.setTag(viewHolder);
            } else {
            ...
            viewHolder.dlCountText.setText(getString(R.string.dl_count, item.getDlCount()));
    ...
    private static class ViewHolder {
        ...
        TextView dlCountText;

    }

    @Override
    ArrayAdapter<Book> generateAdapter() {
        return new StoreBookDLAdapter(getActivity(), R.layout.list_item_store_dl, mStoreBookList);
    }

    @Override
    SSSProductListParam generateSSSParam() {
        SSSProductListParam param = new SSSProductListParam();
        param.setFields("title,outline,summary");
        param.setSorttype("DESC");
        param.setSortfield("summary");
        param.setSummaryType(2);// 週次
