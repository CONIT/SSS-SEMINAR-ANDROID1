...
public abstract class PurchaseObserver {
    ...
    public abstract void onPurchaseStateChange(String producId, String receipt, long purchaseTime);
     ...
     */
    void postPurchaseStateChange(final String producId, final String receipt,
            final long purchaseTime) {
        mHandler.post(new Runnable() {
            public void run() {
                onPurchaseStateChange(producId, receipt, purchaseTime);
            }
        });
    }
}
